...
import { Box, Container, Typography, Button, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper } from '@mui/material';
    ...
    return (
      <Container maxWidth="lg">
        <Box sx={{ my: 4, textAlign: 'center' }}>
          ...
          <Button variant="contained" onClick={loadSongs}>Try Again</Button>
        </Box>
      </Container>
    );
  }
